...
<div class="content container">
  <div class="row">
    ...
    <section class="col-md-5">
      <form class="form-horizontal" action="adminmonthly.php" method="POST">
        <fieldset>
  ...
  <select class="form-control" name="date" id="date">
    <option>January</option>
        ...
        <fieldset>
          <div class="form-group">
            <input type="submit" name="adminshowmonthlyanalysis" class="btn btn-default" value="submit">
        </div> 
        </fieldset>
</form>
    </section>
    ...
    <section class="col-md-5">
      <form class="form-horizontal" action="adminshowcategoryanalysis.php" method="POST">
        <fieldset>
  ...
  <select class="form-control" name="category" id="category">
    ...
    <section class="col-md-5">
      <form class="form-horizontal" action="adminmonthlyanalysis.php" method="POST">
        <fieldset>
